...
exports.genre_detail = asyncHandler(async (req, res, next) => {
	// Get details of genre an all associated books (in parallel)
...
exports.genre_update_post = [
	...
	body("genre", "Genre name must contain at least 3 characters").trim().isLength({ min: 3 }).escape(),
	...
	asyncHandler(async (req, res, next) => {
		...
		// Create a Genre object with escapes/trimmed data and old id.
